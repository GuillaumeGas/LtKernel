...
void init_idt ()
{
    ...
    init_idt_descriptor ((u32) _asm_divided_by_zero_isr, 0x8, 0x8E00, &g_idt_descriptor[0]);
    init_idt_descriptor ((u32) _asm_debug_isr, 0x8, 0x8E00, &g_idt_descriptor[1]);
    init_idt_descriptor ((u32) _asm_non_maskable_int_isr, 0x8, 0x8E00, &g_idt_descriptor[2]);
    init_idt_descriptor ((u32) _asm_breakpoint_isr, 0x8, 0x8E00, &g_idt_descriptor[3]);	
    init_idt_descriptor ((u32) _asm_overflow_isr, 0x8, 0x8E00, &g_idt_descriptor[4]);
    init_idt_descriptor ((u32) _asm_bound_range_exceeded_isr, 0x8, 0x8E00, &g_idt_descriptor[5]);
    init_idt_descriptor ((u32) _asm_invalid_opcode_isr, 0x8, 0x8E00, &g_idt_descriptor[6]);
    init_idt_descriptor ((u32) _asm_device_not_available_isr, 0x8, 0x8E00, &g_idt_descriptor[7]);
    init_idt_descriptor ((u32) _asm_double_fault_isr, 0x8, 0x8E00, &g_idt_descriptor[8]);
    init_idt_descriptor ((u32) _asm_invalid_tss_isr, 0x8, 0x8E00, &g_idt_descriptor[9]);
    init_idt_descriptor ((u32) _asm_segment_not_present_isr, 0x8, 0x8E00, &g_idt_descriptor[10]);
    init_idt_descriptor ((u32) _asm_stack_segment_fault_isr, 0x8, 0x8E00, &g_idt_descriptor[11]);
    init_idt_descriptor ((u32) _asm_general_protection_fault_isr, 0x8, 0x8E00, &g_idt_descriptor[12]);
    init_idt_descriptor ((u32) _asm_page_fault_isr, 0x8, 0x8E00, &g_idt_descriptor[13]);
    init_idt_descriptor ((u32) _asm_x87_floating_point_isr, 0x8, 0x8E00, &g_idt_descriptor[14]);
    init_idt_descriptor ((u32) _asm_alignment_check_isr, 0x8, 0x8E00, &g_idt_descriptor[15]);
    init_idt_descriptor ((u32) _asm_machine_check_isr, 0x8, 0x8E00, &g_idt_descriptor[16]);
    init_idt_descriptor ((u32) _asm_simd_floating_point_isr, 0x8, 0x8E00, &g_idt_descriptor[17]);
    init_idt_descriptor ((u32) _asm_virtualization_isr, 0x8, 0x8E00, &g_idt_descriptor[18]);
    init_idt_descriptor ((u32) _asm_security_isr, 0x8, 0x8E00, &g_idt_descriptor[19]);
    init_idt_descriptor ((u32) _asm_triple_fault_isr, 0x8, 0x8E00, &g_idt_descriptor[20]);
